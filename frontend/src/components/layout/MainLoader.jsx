...
const MainLoader = ({ initialProgress = null }) => {
  ...
  const waves = [
    { amplitude: 40, frequency: 1, phase: 0, opacity: 0.8, yOffset: 0, verticalSpeed: 1.9, color: "#222222" },
    { amplitude: 30, frequency: 0.75, phase: 1, opacity: 0.6, yOffset: 15, verticalSpeed: 1.75, color: "#222222" },
    { amplitude: 25, frequency: 1.25, phase: 0.5, opacity: 0.5, yOffset: 30, verticalSpeed: 1.6, color: "#222222" }
  ];
  ...
  useEffect(() => {
    ...
    const updateLoadingPercent = () => {
      setLoadingPercent(prevPercent => {
        if (prevPercent < 100) {
          const increment = 0.5; // loading demo
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 w-full h-screen flex items-center justify-center bg-red-400 overflow-hidden">
