...
const MainLoader = ({ initialProgress = null }) => {
  ...
  const waves = [
    { amplitude: 20, frequency: 1, phase: 0, opacity: 0.8, yOffset: 0, verticalSpeed: 1.9, color: "#FFFFFF" },
    { amplitude: 18, frequency: 0.75, phase: 1, opacity: 0.6, yOffset: 15, verticalSpeed: 1.75, color: "#FFFFFF" },
    { amplitude: 15, frequency: 1.25, phase: 0.5, opacity: 0.5, yOffset: 30, verticalSpeed: 1.6, color: "#FFFFFF" }
  ];
